            ...
            <div class="section-body">
                <div class="mt-4 row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('admin.coursesapi.index') }}" method="GET"
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h4>{{ __('Courses List') }}-API</h4>
                                <div>
                                    <a href="{{ route('admin.coursesapi.create') }}" class="btn btn-primary"> <i
                                                        ...
                                                        <div>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                                    <a href="{{ route('admin.coursesapi.edit-view', $course->id) }}"
                                                                        class="dropdown-item"
                                                                        target="_blank">{{ __('Edit') }}</a>

                                                                    <a href="{{ route('admin.coursesapi.destroy', $course->id) }}"
