...
namespace Modules\CourseApi\app\Http\Requests;
...
class ChapterLessonRequest extends FormRequest {
    ...
    function activityRules(): array {
        return [
            'chapter'              => ['required', 'exists:course_chapters,id'],
            'title'                => ['required', 'max:255'],
            'description'          => ['nullable', 'max:2000'],
            'material_required'    => ['nullable'],
            'age_min'              => ['nullable', 'integer', 'min:0', 'max:255'],
            'age_max'              => ['nullable', 'integer', 'min:0', 'max:255', 'gte:age_min'],
            'activity_duration'    => ['nullable', 'max:100'],
            'activity_files_paths' => ['nullable', 'array'],
            'activity_files_paths.*' => ['nullable', 'string'],
        ];
    }
