...
@section('title')
    <title>{{ __('All Schools') }}</title>
@endsection
@section('admin-content')
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>{{ __('All Schools') }}</h1>
            </div>
            ...
            <div class="section-body">
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('admin.all-schools') }}" method="GET"
                                    onchange="$(this).trigger('submit')" class="form_padding">
                                    <div class="row">
                                        <div class="col-md-4 form-group">
                                            <input type="text" name="keyword" value="{{ request('keyword') }}"
                                                class="form-control" placeholder="{{ __('Search name, email, school…') }}">
                                        </div>
                                ...
                                <div class="table-responsive table-invoice">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            @empty
                                                <x-empty-table :name="__('School')" route="" create="no"
                                                    :message="__('No schools found!')" colspan="7"></x-empty-table>
                                            @endforelse
                                        </tbody>
                                    </table>
                                </div>
