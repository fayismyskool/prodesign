...
use Modules\Course\app\Http\Controllers\CourseGradeController;
...
Route::group(['middleware' => ['auth:admin', 'translation'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    /** Course Grade CRUD Routes (admin management) */
    Route::put('course-grade/status-update/{id}', [CourseGradeController::class, 'statusUpdate'])->name('course-grade.status-update');
    Route::delete('course-grade-image/{id}/destroy', [CourseGradeController::class, 'imageDestroy'])->name('course-grade.image.destroy');
    Route::resource('course-grade', CourseGradeController::class)->names('course-grade');

    /** Course content grade routes (used inside course builder) */
    Route::post('course-chapter-grade/{course_id}/store', [CourseContentController::class, 'gradeStore'])->name('course-chapter-grade.store');
    Route::get('course-chapter-grade/edit/{grade_id}', [CourseContentController::class, 'gradeEdit'])->name('course-chapter-grade.edit');
    Route::put('course-chapter-grade/update/{grade_id}', [CourseContentController::class, 'gradeUpdate'])->name('course-chapter-grade.update');
    Route::delete('course-chapter-grade/delete/{grade_id}', [CourseContentController::class, 'gradeDestroy'])->name('course-chapter-grade.destroy');
    ...
    Route::delete('course-chapter/activity-file/{file_id}/destroy', [CourseContentController::class, 'activityFileDestroy'])->name('course-chapter.activity-file.destroy');
