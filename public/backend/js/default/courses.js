...
$(document).ready(function () {
    ...
    $("body").on("submit", ".add_lesson_form", function (e) {
        ...
        $.ajax({
            ...
            data: $(form).serialize(),
            beforeSend: function () {
                $("body .dynamic-modal .submit-btn").prop("disabled", true).text("loading...");
            },
            success: function (data) {
            ...
            error: function (xhr) {
                ...
                $.each(errors, function (key, value) { toastr.error(value); });
                $("body .dynamic-modal .submit-btn").prop("disabled", false).text("Create");
            },
        });
    });
    ...
    $("body").on("submit", ".update_lesson_form", function (e) {
        ...
        $.ajax({
            ...
            error: function (xhr) {
                let errors = xhr.responseJSON ? xhr.responseJSON.errors : {};
                $.each(errors, function (key, value) { toastr.error(value); });
                $("body .dynamic-modal .submit-btn").prop("disabled", false).text("Update");
            },
        });
    });
