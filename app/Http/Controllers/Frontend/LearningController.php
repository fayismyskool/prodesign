...
class LearningController extends Controller {
    function index(string $slug) {
        $course = Course::active()->with([
            ...
            'chapters.chapterItems.lesson.activityFiles',
        ...
        // Load global grades with chapters belonging to this course
        ...
        ->orderBy('order')
        ->get()
        ->filter(fn ($g) => $g->chapters->isNotEmpty()); // only grades that have chapters for this course
    ...
    function indexdes(string $slug) {
        ...
        return view('frontend.pages.learning-player.indexNW', compact(
            'course',
            'currentProgress',
            'announcements',
            'courseCompletedPercent',
