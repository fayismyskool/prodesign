...
<div class="modal fade" id="materialModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="border-radius:16px;overflow:hidden;">
            <div class="modal-header" style="background:linear-gradient(135deg,#6d4bc3,#7d5ce0);border:none;">
                                                                ...
                                                                <div class="activity-meta">
                                                                    @if($lesson->material_required)
                                                                        ...
                                                                        <span class="meta-tag meta-tag-material"
                                                                            ...
                                                                            <i class="fas fa-box-open"></i>{{ __('Materials Required') }}
                                                                            <i class="fas fa-info-circle ms-1" style="opacity:.5;font-size:10px;"></i>
                                                                        </span>
                                                                    @endif
                                                                </div>
                                                            @endif
...
// Material Required modal — populate text before showing
